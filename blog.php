            ...
            <article class="entrada-blog">
                <div class="imagen">
                    <picture>
                        ...
                        <source srcset="build/img/blogs3.jpg" type="image/jpg">
            ...
            <article class="entrada-blog">
                <div class="imagen">
                    <picture>
                        ...
                        <source srcset="build/img/blogs4.jpg" type="image/jpg">
            ...
            <article class="entrada-blog">
                <div class="imagen">
                    <picture>
                        ...
                        <img src="build/img/anuncio3.jpg" alt="Texto Entrada Blog" loading="lazy">
                    </picture>
                </div>
                <div class="texto-entrada">
                    <a href="entrada.php">
            ...
            <article class="entrada-blog">
                <div class="imagen">
                    <picture>
                        ...
                        <img src="build/img/anuncio2.jpg" alt="Texto Entrada Blog" loading="lazy">
                    </picture>
                </div>
                <div class="texto-entrada">
                    <a href="entrada.php">
